...
import { basket, fileTrayFull, leaf, menu, people, readerOutline, storefront } from 'ionicons/icons';
...
export class DashboardPage {
  ...
  constructor() {
    addIcons({ basket, fileTrayFull, leaf, menu, people, readerOutline, storefront });
  }
}
